@echo off
REM This script builds and runs a Docker container to test if NEXT_PUBLIC_BACKEND_URL is properly passed

REM Set a test NEXT_PUBLIC_BACKEND_URL value
set NEXT_PUBLIC_BACKEND_URL=http://test-backend-url:5000
